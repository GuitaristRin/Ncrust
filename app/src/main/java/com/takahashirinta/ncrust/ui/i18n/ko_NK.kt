...
val koNK = Strings(
    ...
    loginSendCode = "코드 전송",
    loginSmsCode = "SMS 코드",
    loginWrongCreds = "휴대폰 또는 비밀번호 오류",
    loginCaptchaBlocked = "SMS 전송이 차단됨, 비밀번호 로그인 권장",
    loginCodeSent = "코드가 전송되었습니다",
    loginSendFailed = "전송이 차단되었습니다, 비밀번호 로그인을 이용하세요",
    loginFailed = { c -> "로그인 실패($c)" },

...
val en = Strings(
    ...
    loginWrongCreds = "Wrong phone or password",
    loginCaptchaBlocked = "SMS blocked by captcha, use password instead",
    loginCodeSent = "Code sent, check your messages",
    loginSendFailed = "Send blocked by anti-bot, use password sign-in",
    loginFailed = { c -> "Sign-in failed ($c)" },

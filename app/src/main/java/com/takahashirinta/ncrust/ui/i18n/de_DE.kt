...
val deDE = Strings(
    ...
    loginTabSms = "SMS-Code",
    loginPhone = "Telefonnummer",
    loginPassword = "Passwort",
    loginSubmit = "Anmelden",
    loginSendCode = "Code senden",
    loginSmsCode = "SMS-Code",
    loginWrongCreds = "Falsche Telefonnummer oder Passwort",
    loginCaptchaBlocked = "SMS blockiert, bitte Passwort verwenden",
    loginCodeSent = "Code gesendet, siehe Nachrichten",
    loginSendFailed = "Senden blockiert, bitte Passwort-Anmeldung nutzen",
    loginFailed = { c -> "Anmeldung fehlgeschlagen ($c)" },

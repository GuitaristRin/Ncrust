...
val ruRU = Strings(
    ...
    loginTabPassword = "Пароль",
    loginTabSms = "SMS-код",
    loginPhone = "Телефон",
    loginPassword = "Пароль",
    loginSubmit = "Войти",
    loginSendCode = "Отправить код",
    loginSmsCode = "SMS-код",
    loginWrongCreds = "Неверный телефон или пароль",
    loginCaptchaBlocked = "SMS заблокирован, используйте пароль",
    loginCodeSent = "Код отправлен, проверьте сообщения",
    loginSendFailed = "Отправка заблокирована, используйте пароль",
    loginFailed = { c -> "Ошибка входа ($c)" },
